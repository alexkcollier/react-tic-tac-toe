...
This was a quick react learning experience. It uses:
- `prop-types`
- `styled-components`
- `eslint/prettier/stylelint` with airbnb config

It could likely be improved with `mobx/redux`. Another improvement would be player name inputs. Tests would be a good idea too.
